...
public class ReadonlyQueryCollection<T0, T1, T2, T3, T4, T5> : IQueryCollection
    ...
    public ComponentEnumerable<T0, T1, T2, T3, T4, T5> GetComponents() {
        if (!IsValid) {
            throw new InvalidOperationException("This collection is invalid.");
        }

        return new ComponentEnumerable<T0, T1, T2, T3, T4, T5>(_world, _ids, _components0, _components1, _components2,
    ...
    internal class ReadonlyQueryCollectionBuilder {
        ...
        public ReadonlyQueryCollection<T0, T1, T2, T3, T4, T5> Build() {
            ...
            return new ReadonlyQueryCollection<T0, T1, T2, T3, T4, T5>(_world, ids.ToArray(),
