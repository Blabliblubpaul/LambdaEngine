...
public class ReadonlyQueryCollection<T0, T1, T2, T3, T4, T5, T6> : IQueryCollection
    ...
    public ComponentEnumerable<T0, T1, T2, T3, T4, T5, T6> GetComponents() {
        if (!IsValid) {
            throw new InvalidOperationException("This collection is invalid.");
        }

        return new ComponentEnumerable<T0, T1, T2, T3, T4, T5, T6>(_world, _ids, _components0, _components1, _components2,
            _components3, _components4, _components5, _components6);
    }
    ...
    internal class ReadonlyQueryCollectionBuilder {
        ...
        public ReadonlyQueryCollection<T0, T1, T2, T3, T4, T5, T6> Build() {
            ...
            return new ReadonlyQueryCollection<T0, T1, T2, T3, T4, T5, T6>(_world, ids.ToArray(),
                memory0.ToArray(), memory1.ToArray(), memory2.ToArray(),
                memory3.ToArray(), memory4.ToArray(), memory5.ToArray(),
                memory6.ToArray());
        }
    }
}