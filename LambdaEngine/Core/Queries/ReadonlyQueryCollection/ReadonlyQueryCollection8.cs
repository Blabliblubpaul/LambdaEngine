...
public class ReadonlyQueryCollection<T0, T1, T2, T3, T4, T5, T6, T7> : IQueryCollection
    ...
    internal class ReadonlyQueryCollectionBuilder {
        ...
        public ReadonlyQueryCollection<T0, T1, T2, T3, T4, T5, T6, T7> Build() {
            ...
            return new ReadonlyQueryCollection<T0, T1, T2, T3, T4, T5, T6, T7>(_world, ids.ToArray(),
