...
public ref struct ComponentEnumerator<T0, T1>
    ...
    /// <summary>
    /// Returns a <see cref="ComponentRef{T0,T1}"/> for the index to which the enumerator is currently pointing.
    ...
    public ComponentRef<T0, T1> Current {
        get {
