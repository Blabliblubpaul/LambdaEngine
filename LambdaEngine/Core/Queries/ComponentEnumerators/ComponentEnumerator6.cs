...
public ref struct ComponentEnumerator<T0, T1, T2, T3, T4, T5>
    ...
    /// <summary>
    /// Returns a <see cref="ComponentRef{T0,T1,T2,T3,T4,T5}"/> for the index to which the enumerator is currently pointing.
    ...
    public ComponentRef<T0, T1, T2, T3, T4, T5> Current {
        get {
            ...
            if (IsValid && !_isAtEnd) {
                return new ComponentRef<T0, T1, T2, T3, T4, T5>(
