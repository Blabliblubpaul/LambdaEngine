...
public ref struct ComponentEnumerator<T0, T1, T2, T3, T4, T5, T6, T7>
    ...
    private readonly Memory<T7>[] _components7;
    ...
    /// <summary>
    /// Returns a <see cref="ComponentRef{T0,T1,T2,T3,T4,T5,T6,T7}"/> for the index to which the enumerator is currently pointing.
    ...
    public ComponentRef<T0, T1, T2, T3, T4, T5, T6, T7> Current {
        get {
            ...
            if (IsValid && !_isAtEnd) {
                return new ComponentRef<T0, T1, T2, T3, T4, T5, T6, T7>(
                    ...
                    ref _components7[_arrayIndex].Span[_componentIndex]);
            }
    ...
    internal ComponentEnumerator(EcsWorld world,
        ...
        _components7 = new Memory<T7>[components7.Length];
