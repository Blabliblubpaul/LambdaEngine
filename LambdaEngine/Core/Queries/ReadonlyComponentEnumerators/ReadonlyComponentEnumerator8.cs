...
public ref struct ReadonlyComponentEnumerator<T0, T1, T2, T3, T4, T5, T6, T7>
    ...
    private readonly ReadOnlyMemory<T5>[] _components5;
    private readonly ReadOnlyMemory<T6>[] _components6;
    private readonly ReadOnlyMemory<T7>[] _components7;
    ...
    /// <summary>
    /// Returns a <see cref="ReadonlyComponentRef{T0,T1,T2,T3,T4,T5,T6,T7}"/> for the index to which the enumerator is currently pointing.
    ...
    public ReadonlyComponentRef<T0, T1, T2, T3, T4, T5, T6, T7> Current {
        get {
            ...
            if (IsValid && !_isAtEnd) {
                return new ReadonlyComponentRef<T0, T1, T2, T3, T4, T5, T6, T7>(
                    ...
                    in _components5[_arrayIndex].Span[_componentIndex],
                    in _components6[_arrayIndex].Span[_componentIndex],
                    in _components7[_arrayIndex].Span[_componentIndex]);
            }
    ...
    internal ReadonlyComponentEnumerator(EcsWorld world,
        ...
        NativeMemoryManager<T7>[] components7) {
        _world = world;
        ...
        _components5 = new ReadOnlyMemory<T5>[components5.Length];
        _components6 = new ReadOnlyMemory<T6>[components6.Length];
        _components7 = new ReadOnlyMemory<T7>[components7.Length];
        ...
        for (int i = 0; i < ids.Length; i++) {
            ...
            _components7[i] = components7[i].Memory;
        }
