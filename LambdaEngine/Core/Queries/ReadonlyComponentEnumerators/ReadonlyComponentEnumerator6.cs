...
public ref struct ReadonlyComponentEnumerator<T0, T1, T2, T3, T4, T5>
    ...
    /// <summary>
    /// Returns a <see cref="ReadonlyComponentRef{T0,T1,T2,T3,T4,T5}"/> for the index to which the enumerator is currently pointing.
    ...
    public ReadonlyComponentRef<T0, T1, T2, T3, T4, T5> Current {
        get {
            ...
            if (IsValid && !_isAtEnd) {
                return new ReadonlyComponentRef<T0, T1, T2, T3, T4, T5>(
