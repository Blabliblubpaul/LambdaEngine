...
public class ComponentEnumerable<T0, T1, T2, T3, T4, T5, T6, T7>
    ...
    public ComponentEnumerator<T0, T1, T2, T3, T4, T5, T6, T7> GetEnumerator() {
        if (!IsValid) {
            throw new InvalidOperationException("This collection is invalid.");
        }

        return new ComponentEnumerator<T0, T1, T2, T3, T4, T5, T6, T7>(_world, _ids, _components0, _components1, _components2,
            _components3, _components4, _components5, _components6, _components7);
    }
}