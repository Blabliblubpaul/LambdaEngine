...
public class ComponentEnumerable<T0, T1, T2, T3, T4, T5, T6>
    ...
    public ComponentEnumerator<T0, T1, T2, T3, T4, T5, T6> GetEnumerator() {
        if (!IsValid) {
            throw new InvalidOperationException("This collection is invalid.");
        }

        return new ComponentEnumerator<T0, T1, T2, T3, T4, T5, T6>(_world, _ids, _components0, _components1, _components2,
