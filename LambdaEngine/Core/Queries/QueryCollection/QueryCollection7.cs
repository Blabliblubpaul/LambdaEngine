...
public class QueryCollection<T0, T1, T2, T3, T4, T5, T6> : IQueryCollection
    ...
    internal class QueryCollectionBuilder {
        ...
        public QueryCollection<T0, T1, T2, T3, T4, T5, T6> Build() {
            ...
            return new QueryCollection<T0, T1, T2, T3, T4, T5, T6>(_world, ids.ToArray(),
