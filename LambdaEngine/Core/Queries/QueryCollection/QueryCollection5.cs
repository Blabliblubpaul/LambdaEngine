...
public class QueryCollection<T0, T1, T2, T3, T4> : IQueryCollection
    ...
    internal class QueryCollectionBuilder {
        ...
        public QueryCollection<T0, T1, T2, T3, T4> Build() {
            ...
            return new QueryCollection<T0, T1, T2, T3, T4>(_world, ids.ToArray(), memory0.ToArray(), 
