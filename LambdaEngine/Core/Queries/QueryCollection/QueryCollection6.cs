...
public class QueryCollection<T0, T1, T2, T3, T4, T5> : IQueryCollection
    ...
    internal class QueryCollectionBuilder {
        ...
        public QueryCollection<T0, T1, T2, T3, T4, T5> Build() {
            ...
            return new QueryCollection<T0, T1, T2, T3, T4, T5>(_world, ids.ToArray(),
