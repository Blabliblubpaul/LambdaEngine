...
public partial class EcsQuery {
    public QueryCollection<T0> Execute<T0>() where T0 : unmanaged, IEcsComponent {
        ...
        return _world.ExecuteQuery<T0>(this);
    }

    public QueryCollection<T0, T1> Execute<T0, T1>()
        ...
        return _world.ExecuteQuery<T0, T1>(this);
    }

    public QueryCollection<T0, T1, T2> Execute<T0, T1, T2>()
        where T0 : unmanaged, IEcsComponent
        where T1 : unmanaged, IEcsComponent
        ...
        return _world.ExecuteQuery<T0, T1, T2>(this);
    }

    public QueryCollection<T0, T1, T2, T3> Execute<T0, T1, T2, T3>()
        where T0 : unmanaged, IEcsComponent
        where T1 : unmanaged, IEcsComponent
        where T2 : unmanaged, IEcsComponent
        ...
        return _world.ExecuteQuery<T0, T1, T2, T3>(this);
    }

    public QueryCollection<T0, T1, T2, T3, T4> Execute<T0, T1, T2, T3, T4>()
        where T0 : unmanaged, IEcsComponent
        where T1 : unmanaged, IEcsComponent
        where T2 : unmanaged, IEcsComponent
        where T3 : unmanaged, IEcsComponent
        ...
        return _world.ExecuteQuery<T0, T1, T2, T3, T4>(this);
    }

    public QueryCollection<T0, T1, T2, T3, T4, T5> Execute<T0, T1, T2, T3, T4, T5>()
        where T0 : unmanaged, IEcsComponent
        where T1 : unmanaged, IEcsComponent
        where T2 : unmanaged, IEcsComponent
        where T3 : unmanaged, IEcsComponent
        ...
        return _world.ExecuteQuery<T0, T1, T2, T3, T4, T5>(this);
    }

    public QueryCollection<T0, T1, T2, T3, T4, T5, T6> Execute<T0, T1, T2, T3, T4, T5, T6>()
        where T0 : unmanaged, IEcsComponent
        where T1 : unmanaged, IEcsComponent
        where T2 : unmanaged, IEcsComponent
        where T3 : unmanaged, IEcsComponent
        ...
        return _world.ExecuteQuery<T0, T1, T2, T3, T4, T5, T6>(this);
    }

    public QueryCollection<T0, T1, T2, T3, T4, T5, T6, T7> Execute<T0, T1, T2, T3, T4, T5, T6, T7>()
        where T0 : unmanaged, IEcsComponent
        where T1 : unmanaged, IEcsComponent
        where T2 : unmanaged, IEcsComponent
        where T3 : unmanaged, IEcsComponent
        ...
        return _world.ExecuteQuery<T0, T1, T2, T3, T4, T5, T6, T7>(this);
    }
}