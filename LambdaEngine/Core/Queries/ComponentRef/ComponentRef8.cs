...
public readonly ref struct ComponentRef<T0, T1, T2, T3, T4, T5, T6, T7>
    ...
    private readonly ref T7 _item7;

    internal ComponentRef(int id, ref T0 item0, ref T1 item1, ref T2 item2, ref T3 item3, ref T4 item4, ref T5 item5, ref T6 item6, ref T7 item7) {
        Id = id;
