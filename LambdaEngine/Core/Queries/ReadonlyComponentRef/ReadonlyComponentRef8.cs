...
public readonly ref struct ReadonlyComponentRef<T0, T1, T2, T3, T4, T5, T6, T7>
    ...
    private readonly ref readonly T7 _item7;

    internal ReadonlyComponentRef(int id, ref readonly T0 item0, ref readonly T1 item1, ref readonly T2 item2,
        ref readonly T3 item3, ref readonly T4 item4, ref readonly T5 item5, ref readonly T6 item6, ref readonly T7 item7) {
        Id = id;
